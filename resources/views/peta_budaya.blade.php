...
body {
    ...
    background: url("{{ asset('bgpastel.jpg') }}");
    position: relative;
}
...
.page-wrap::before {
    left: 0;
    background: url("{{ asset('batik.jpg') }}");
}
...
<!-- BACKSOUND -->
<audio id="bgm" loop>
    <source src="{{ asset('backsound.mp3') }}" type="audio/mpeg">
</audio>
...
<script>
    ...
    // ====== DOM element ======
    const petaImg = document.getElementById("petaImg");
    ...
    let pinEl = null;
    // ===== SOUND EFFECT KLIK =====
const clickSfx = new Audio("{{ asset('click.mp3') }}"); // ganti nama file kalau beda
