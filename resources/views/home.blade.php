...
<body>
    ...
    <article class="menu-card info">
        <div class="menu-card-inner">
            ...
            <div class="menu-footer">
                ...
                <a href="/pemberitahuan" class="menu-btn">Buka Pemberitahuan →</a>
            </div>
        </div>
    </article>
    ...
    <!-- KUIS -->
                <article class="menu-card hard">
                    <div class="menu-card-inner">
                        <div class="menu-top">
                            <div class="menu-badge"><span class="mini-dot"></span> Kuis • Sejarah</div>
                            <div class="menu-icon">🔶</div>
                        </div>
                        <div class="menu-title">Mode Kuis</div>
                        <div class="menu-desc">
                            Uji pengetahuanmu dengan soal-soal sejarah budaya Indonesia yang beragam.
                        </div>
                        <div class="menu-footer">
